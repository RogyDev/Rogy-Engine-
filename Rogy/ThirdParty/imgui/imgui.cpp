...
ImGuiIO::ImGuiIO()
{
    ...
    IniSavingRate = 5.0f;
    IniFilename = "editorUI.ini";
    LogFilename = "editor_UI_log.txt";
...
void ImGui::RenderTextClippedEx(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_display_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect, float font_text_size)
{
    ...
    if (need_clipping)
    {
        ...
        draw_list->AddText(NULL, font_text_size, pos, GetColorU32(ImGuiCol_Text), text, text_display_end, 0.0f, &fine_clip_rect);
    }
    else
    {
        draw_list->AddText(NULL, font_text_size, pos, GetColorU32(ImGuiCol_Text), text, text_display_end, 0.0f, NULL);
    }
}
...
ImVec2 ImGui::CalcTextSize(const char* text, const char* text_end, bool hide_text_after_double_hash, float wrap_width, float text_sizes)
{
    ImGuiContext& g = *GImGui;
    ...
    ImFont* font = g.Font;
    const float font_size = g.FontSize * text_sizes;
    if (text == text_display_end)
