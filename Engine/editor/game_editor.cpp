...
bool Game_Editor::Init(char* glsl_version, GLFWwindow* window)
{
...
void Game_Editor::CreateEntityWithMesh(std::string ent_name, std::string mesh_path)
{
...
void Game_Editor::ToolBar()
{
	if (ImGui::BeginMainMenuBar())
	{
		...
		if (ImGui::BeginMenu("Edit"))
		{
			...
			ImGui::Separator();
			if (ImGui::MenuItem("Open Scripting Editor"))
			{
			}
		...
		if (ImGui::BeginMenu("Add"))
		{
			...
			{
				CreateEntityWithMesh("Cube", "core\\models\\cube.obj");
			}
			if (ImGui::Selectable("Capsule"))
			{
				CreateEntityWithMesh("Capsule", "core\\models\\capsule.obj");
			}
			if (ImGui::Selectable("Plane"))
			{
				CreateEntityWithMesh("Plane", "core\\models\\plane.obj");
			}
			if (ImGui::Selectable("Sphere"))
			{
				CreateEntityWithMesh("Sphere", "core\\models\\sphere.obj");
			}
			ImGui::Separator();
...
void Game_Editor::DockSpaces()
{
	...
	if (scripts_board)
	{
		...
		ImGui::TextColored(ImVec4(0.6f, 0.6f, 0.6f, 0.6f), "Put script editors here (Not stable yet :<)");
