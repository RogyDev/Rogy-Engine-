...
// ---------------------------------------------------------------
// ---------------------------------------------------------------
Entity* SceneManager::AddEntity(string ent_name)
{
	return AddEntity(-1, ent_name);
}
// ---------------------------------------------------------------
Entity* SceneManager::AddEntity(EnttID entity_id, string Name)
{
...
// ---------------------------------------------------------------
void SceneManager::SaveBP(cereal::BinaryOutputArchive& ar)
{
